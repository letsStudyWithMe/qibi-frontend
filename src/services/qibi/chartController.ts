...
/** genChartByAi POST /api/chart/genChartByAi */
export async function genChartByAiUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/genChartByAi', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiRabbitMQ POST /api/chart/genChartByAiRabbitMQ */
export async function genChartByAiRabbitMqUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiRabbitMQUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/genChartByAiRabbitMQ', {
    method: 'POST',
    params: {
      ...params,
    },
